  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "18px" }}>
        <h3 style={{ fontSize: "18px", fontWeight: "700", color: "#fff", margin: "0 0 8px", lineHeight: 1.4 }}>{title}</h3>
        <p style={{ fontSize: "14px", color: "rgba(255,255,255,0.45)", lineHeight: 1.65, margin: "0 0 18px" }}>{subtitle}</p>

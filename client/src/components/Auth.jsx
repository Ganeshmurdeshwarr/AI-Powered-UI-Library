      ...
      >
        ...
        >
          ...
          <div className="sm:w-[52%] bg-gradient-to-br from-[#03181c] to-[#041e24] p-6 sm:p-10 relative overflow-hidden">
            ...
            >
              <div className="w-9 h-9 rounded-xl bg-gradient-to-r from-[#3be8ff] to-[#0ab5d4] flex items-center justify-center shadow-[0_0_18px_rgba(59,232,255,0.35)] ">
                <SiValorant size={17} color="#51c20" />
              </div>
              <span
            ...
            <div className="flex sm:flex-col gap-2 sm:gap-1 overflow-x-auto sm:overflow-x-visible sm:pb-0 -mx-1 px-1"></div>

            {steps.map((item, i) => (
              <motion.div
                key={i}
                className={`shrink-0 sm:shrink flex items-start gap-3 px-3 py-2.5 rounded-xl border transition-all duration-300 min-w-[200px] sm:min-w-0 ${active === i ? "bg-[#3be8ff]/7 border-[#3be8ff]/20 " : "bg-transparent border-transparent"} `}
              >
                <div
                  className={`min-w-[28px] h-7 rounded-lg flex items-center justify-center border transition-all duration-300 ${active === i ? "bg-gradient-to-r from-[#3be8ff] to-[#0ab8d6] border-transparent" : "bg-[#3be8ff]/8 border-[#3be8ff]/20 "}`}
                >
                  <item.icon
                    size={13}
                ...
                <div className="">
                  ...
                  >
                    <p className="text-[11px] tex-[#3be8ff]/40 leading-relaxed ">
                      {item.desc}
                    </p>
                  </div>
                </div>
          ...
          >
            ...
            <div className="relative z-10 w-full max-w-[280px] sm:max-w[260px] text-center mx-auto">
              <motion.div
                ...
                className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl mx-auto mb-5 sm:mb-6 bg-gradient-to-br from-[#3be8ff]/20 flex items-center justify-center  "
              >
              ...
              <p className="text-[13px] text-[#96bec8]/55 leading-relaxed mb-6 sm:mb-7 ">
                Sing in to generate AI-powered UI components in seconds
              </p>
              ...
              onClick={googleAuth}
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full flex items-center justify-center gap-2.5 py-3.5 rounded-xl bg-white text-black font-semibold text-sm cursor-pointer border-none shadow-[0_4px_20px_rgba(0,0,0,0.3)] hover:shadow-[0_12px_40px_rgba(59,232,255,0.2)] transition-shadow"
              >
